                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	...
                            	<div class="commentDetail card w-90 m-4 p-3 bg-white rounded">
	                            	<h4 class="m-0 font-weight-bold text-primary">신고된 댓글의 내용</h4>
								...
								<div class="scantionChoice card w-90 m-4 p-3 bg-white rounded">
	                                ...
	                                <br><form action="/admin/complaintEnd" method="post">
		                                <c:if test="${isDeleted==true}"> <font class="text-primary">댓글이 삭제되었습니다.</font><br></c:if>
		                              	<c:if test="${isDeleted==false}"><span id="deleteResult"></span><a class="btn reply_comment btn-outline-danger" href="#" id="targetDelete">댓글 삭제</a><br></c:if>
